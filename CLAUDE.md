...
Mio·AI 办公搭子（2026-09 改名，旧名对照见 `juzibot-redlines` skill，仓库里不再出现旧名；页面 `products/mio.html`，旧 `canmou.html` 只留跳转桩；2026-09-21 起所有产品列表 Mio 排第一）、秒回·工作台、秒懂·大脑、守护·主管、懂行·记忆、CLI·手、制造·地基。
