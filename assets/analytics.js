...
(function () {
  ...
  var PAGE_BY_ENTITY = {
    ...
    mio: { first_menu: '产品', second_menu: 'Mio', entity_type: 'product', entity_name: 'Mio · AI 办公搭子' },
    canmou: { first_menu: '产品', second_menu: 'Mio', entity_type: 'product', entity_name: 'Mio · AI 办公搭子' },
