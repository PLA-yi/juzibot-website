...
(function () {
  ...
  var NAV = '' +
    ...
    '        <a href="' + REL + 'products/dongxing.html"><div class="d-title">句子懂行 · 记忆</div><div class="d-desc">把资料和业务规则变成 AI 员工的记忆</div></a>' +
    ...
    '    <a href="https://az-bg.juzibot.com/auth/register" target="_blank" rel="noopener" class="nav-login" data-track-name="登录 / 注册" data-track-source="导航·登录注册" data-track-area="顶部导航栏">登录 / 注册</a>' +
    '  </div>' +
